 ...
 * Displays information about AI Agent design patterns
 * 
 * @returns {JSX.Element}
 */
const PatternsPage = () => {
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            const sections = patternsData.sections.map(section => section.id);
    ...
    return (
        <div className="container">
            <div className="page-header">
                <h1>{patternsData.pageTitle}</h1>
                <p className="page-description">{patternsData.pageDescription}</p>
                <button
            ...
            <div className="content-with-sidebar">
                ...
                <aside className={`sidebar-toc ${isTableOfContentsOpen ? 'open' : ''}`}>
                    ...
                    <nav className="toc-nav">
                        <ul>
                            {patternsData.sections.map(section => (
                                <li key={section.id}>
                                    <a
                                        href={`#${section.id}`}
                ...
                <main className="main-content">
                    ...
                    <section className="related-links">
                        ...
                        <div className="grid">
                            {patternsData.relatedLinks.map((link, index) => (
                                <Card
                                    key={index}
                                    title={link.title}
